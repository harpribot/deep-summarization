...
lstm_net = lstm_stacked_simple.NeuralNet(review_summary_file, checkpointer, attention =True)
lstm_net.set_parameters(train_batch_size=15,test_batch_size=25, memory_dim=15,learning_rate=0.05)
